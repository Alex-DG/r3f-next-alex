...
const Card = () => {
  return (
    <CardContainer className='absolute left-0 right-0 z-20 p-5 m-0 m-auto shadow rounded-md bg-gray-50 w-60 top-1/4 md:m-5 md:top-0'>
      <Figure>
